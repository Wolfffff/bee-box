...
def edgeListParser ():
    ...
    edge_list_parser.add_argument('--tag', help = 'Tag To Identify All Matches', type = int, required = True)
...
if __name__ == '__main__':
    ...
    distance_distribution(edge_list_args.input, edge_list_args.tag)
    # interaction_length_distribution('../AndrewPipeline_082621/input/CutDeckData.34L.tsv', 31, maximum_distance_for_interaction_threshold = 400.)
    # print_all_long_interactions(edge_list_args.euclidean_distance_minimum.input)
