...
with h5py.File('d:\\sleap-tigergpu\\20210505_run003_00000000.avi.predictions.slp', 'r') as f:
    keys = list(f.keys())
    print(keys)
...
def plot_all_instances_in_same_frame(frame, frames_key, sleap_predictions, sleap_instances, video_path):
    frame_coords = []
    ...
    for idx in idcs[0]:
        ...
        for j in range(start_index, end_index):
            ...
            print('Drew circle! (' + str(prediction_tuple[0]) + ', ' + str(prediction_tuple[1]) + ')')
...
inst_coords = plot_all_instances_in_same_frame(700, frames_key, sleap_predictions, sleap_instances, 'd:\\sleap-tigergpu\\20210505_run003_00000000.mp4')
cv2.waitKey(0)
