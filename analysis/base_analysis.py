...
bee_tracks_df = pd.read_csv(
    "/Genomics/ayroleslab2/scott/bees/data/20210909_run000_00000000_48Hrs_libx264_000_test/20210909_run000_00000000_48Hrs_libx264_000_test_aruco_data_with_track_numbers.csv"
)
# %%
...
bee_vel = (
    trx_utils.instance_node_velocities_bees(bee_tracks, 0, bee_tracks.shape[0])
    * (1 / px_mm)
    * frame_rate
)
...
cap = cv2.VideoCapture(
    "/Genomics/ayroleslab2/scott/bees/new_training/20210909_run000_00000000_48Hrs_libx264.mp4"
)
...
] = "/Genomics/argo/users/swwolf/.conda/envs/sleap_dev/bin/ffmpeg"
