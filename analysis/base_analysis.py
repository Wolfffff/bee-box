...
bee_tracks_df = pd.read_csv("d:\\bee_test\\files\\test_aruco_data_with_track_numbers.csv")
...
plt.rcParams['animation.ffmpeg_path'] = 'D:\\ffmpeg-4.4-essentials_build\\ffmpeg-4.4-essentials_build\\bin\\ffmpeg.exe'
